...
<body>
    <main class="card">
        ...
        <p>
            ...
            sambil mencoba memuat ulang otomatis setiap <strong>2 detik</strong>.
        </p>

        <section class="status-box">
            <strong>Status</strong>
            <p>Jika Laragon, web server, database, atau proses deploy baru saja dijalankan ulang, tunggu sebentar sampai layanan pulih.</p>
        </section>
        ...
        <p class="hint">Halaman ini akan refresh otomatis sampai server kembali normal.</p>
    </main>
